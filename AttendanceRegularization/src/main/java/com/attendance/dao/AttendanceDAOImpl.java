...
public class AttendanceDAOImpl implements AttendanceDAO {
    ...
    public int createAttendance(Attendance attendance) throws SQLException {
...
//        }
        conn.commit();
        if(insertStatus >0){
            log.info("DAO status" +0);
            //return 0;
        }else {
            log.info("DAO status" +insertStatus);
            //return 1;
        }
        return insertStatus;
    ...
    public List<Attendance> retrieveAttendanceByDate(LocalDate date) throws SQLException {
     ...
     * @throws SQLException
     */
    public int deleteAttendance(String[] multiple) throws SQLException {
