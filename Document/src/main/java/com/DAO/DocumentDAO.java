...
public class DocumentDAO {
     ...
     * @return status
     */
    public int createDocumentDAO(DocumentModel document) {
     ...
     * @return status
     */
    public int deleteMultipleDocument(int id) throws SQLException {
     ...
     * @return list
     */
    public List<DocumentModel> retreiveDocumentDAO() {
        //This is a select query to retrieve data from data base
        String query = "SELECT id,Title,Related_contacts,owner,created_date FROM Document_schema.document_table";
